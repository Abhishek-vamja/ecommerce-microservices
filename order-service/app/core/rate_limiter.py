...
redis_client = Redis(host=settings.REDIS_HOST, port=settings.REDIS_PORT, db=0, decode_responses=True, protocol=2)


def rate_limit(max_requests: int, window_seconds: int, key_prefix: str = "rl:order") -> Callable:
